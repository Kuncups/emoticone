    ...
    return (
        <>
            <div class="min-h-screen flex flex-col items-center justify-center bg-[#F9D371]">
                ...
                <div class='mt-14 flex gap-10 items-center justify-center' style="width: 1391px; height: 854px; background: #BA43F2; box-shadow: 9px 19px 5.5px rgba(0, 0, 0, 0.25); border-radius: 75px; border: 1px black solid">
                    {/* Image Grid */}

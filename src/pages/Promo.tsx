...
const Promo = () => {
    ...
    // Array of image data
    const imageData = [
        { imageUrl: 'image7.png', title: 'Bubblegum Bliss', description: 'Bubblegum Bliss Ice Cream is ice cream that is full of creamy smoothness and the taste of bubble gum', price: 'Rp.10.000', newprice: 'Rp.8.000', },
        { imageUrl: 'image7.png', title: 'Bubblegum Bliss', description: 'Bubblegum Bliss Ice Cream is ice cream that is full of creamy smoothness and the taste of bubble gum', price: 'Rp.10.000', newprice: 'Rp.8.000', },
        { imageUrl: 'image7.png', title: 'Bubblegum Bliss', description: 'Bubblegum Bliss Ice Cream is ice cream that is full of creamy smoothness and the taste of bubble gum', price: 'Rp.10.000', newprice: 'Rp.8.000', },
        { imageUrl: 'image7.png', title: 'Bubblegum Bliss', description: 'Bubblegum Bliss Ice Cream is ice cream that is full of creamy smoothness and the taste of bubble gum', price: 'Rp.10.000', newprice: 'Rp.8.000', },
        { imageUrl: 'image7.png', title: 'Bubblegum Bliss', description: 'Bubblegum Bliss Ice Cream is ice cream that is full of creamy smoothness and the taste of bubble gum', price: 'Rp.10.000', newprice: 'Rp.8.000', },
                    ...
                    <div class="grid grid-cols-2 gap-10">
                        {imageData.map((data) => (
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div class="w-80 h-64 text-justify">
                                    ...
                                    <p class="text-orange-300 text-lg font-bold font-sans -mt-4">{data.newprice}</p>
                                </div>
                            </div>
                        ))}
                    </div>
